Scenario: TC_005_Manager_001 Arabic Manager User Storage Hierarchy Privileges
...
And [Input] Set 'Password Input' value to '123'
...
And [Input] I click on 'sort User Id'
And [Progress] I wait for '5' sec
When [Input] I click on 'Edit Storage Hierarchy Privileges Button'
And [Input] Select 'p:AutomationTree' value from 'Storage Hierarchy Privileges Tree Dropdown'
And [Input] I click on 'Automation Document Class Checkbox'
And [Input] I click on 'Select All Document Class Privileges Button'
And [Progress] I wait for '3' sec
And [Input] I click on 'Save Document Class Privileges Button'
And [Progress] I wait for '3' sec
And [Action] I count the number of 'mat-checkbox' elements and save as 'checkboxRowCount'
And [Assertion] Exactly one checkbox is unchecked to approaches 'checkboxRowCount'
And [Input] I click on 'Back Document Class Privileges Button'
And [Progress] I wait for '5' sec
And [Input] I click on 'sort User Id'
And [Progress] I wait for '5' sec
And [Input] I click on 'sort User Id'
And [Progress] I wait for '5' sec
And [Input] I click on 'Edit Storage Hierarchy Privileges Button'
And [Input] Select 'p:AutomationTree' value from 'Storage Hierarchy Privileges Tree Dropdown'
And [Input] I click on 'Automation Document Class Button'
And [Assertion] Exactly one checkbox is unchecked to approaches 'checkboxRowCount'
And [Input] I click on 'Clear All Document Class Privileges Button'
And [Progress] I wait for '3' sec
And [Input] I click on 'Save Document Class Privileges Button'
And [Progress] I wait for '3' sec
...
Scenario: TC_005_Manager_002 English Manager User Storage Hierarchy Privileges
